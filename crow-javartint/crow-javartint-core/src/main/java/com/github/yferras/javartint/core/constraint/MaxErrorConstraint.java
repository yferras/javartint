 ...
 *            {@link com.github.yferras.javartint.core.ErrorBasedAlgorithm}
 *            interface.
...
public class MaxErrorConstraint<A extends ErrorBasedAlgorithm<? extends Solution>>
	 ...
	 * {@inheritDoc}
	 * <p/>
	 * If the actual error of algorithm is greater than the threshold, in this
	 * case returns <code>true</code>, otherwise returns <code>false</code>.
	 */
	@Override
