...
/**
 * Abstract class that implements a general methods from
 * {@link com.github.yferras.javartint.core.Algorithm}.
 *
 * @param <S>
...
public abstract class AbstractAlgorithm<S extends Solution> implements Algorithm<S> {
	 ...
	 *
	 * @param listener
	 *            the execution end listener instance.
	 ...
	 *
	 * @param listener
	 *            the solution change listener instance.
	 * @return Returns {@code true} if this instance is already contained,
	 *         {@code false} otherwise.
	 */
	...
	/**
	 * Removes the specified execution end listener. See
	 * {@link java.util.List#remove(java.lang.Object)}
	 *
	 * @param listener
	 *            the execution end listener instance.
	 * @return Returns {@code true} if this instance is already contained,
	...
	/**
	 * Removes the specified solution change listener. See
	 * {@link java.util.List#remove(java.lang.Object)}
	 *
	 * @param listener
	 *            the solution change listener instance.
