...
public interface Constraint<A extends Algorithm<? extends Solution>> {
	...
	/**
	 * Test any parameter of the algorithm and if this constraint is satisfied
	 * then returns <code>true</code>, otherwise returns <code>false</code>.
	 *
	 * @param algorithm
	 *            algorithm to test.
	 * @return if this constraint is satisfied then returns <code>true</code>,
