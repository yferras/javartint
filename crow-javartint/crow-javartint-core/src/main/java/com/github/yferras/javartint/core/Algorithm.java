...
public interface Algorithm<S extends Solution> extends Runnable {
	 ...
	 * the following cases:
	 * <ul>
	 * <li>If and only if all mandatory constraints return
	 * <code>true</code>.</li>
	 * <li>Or in the case that will not exist mandatory constrains, with only
	 * one optional constraint that return <code>true</code>.</li>
	 * </ul>
