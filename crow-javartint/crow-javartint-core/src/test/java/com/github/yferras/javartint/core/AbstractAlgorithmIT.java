...
public class AbstractAlgorithmIT {
	...
	@Before
	public void setUp() {
		System.out.print(AbstractAlgorithm.class.getName().concat("."));
	}
	...
	public void testGetConstraints() {
		...
		AbstractAlgorithm instance = new AlgorithmImpl();
		Constraint[] expResult = new Constraint[] { new MaxIterationsConstraint(ConstraintType.MANDATORY, 100L),
	...
	public void testRemoveConstraint() {
		...
		AbstractAlgorithm instance = new AlgorithmImpl();
		Constraint[] constraints = new Constraint[] { new MaxIterationsConstraint(ConstraintType.MANDATORY, 100L),
				new MinErrorConstraint(ConstraintType.MANDATORY, 0.0) };
