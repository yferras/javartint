...
public class ProbabilisticFunctionTest {
	...
	public void testConstructor1() {
		System.out.println("constructor " + "(test probability less than 0.0)");
		try {
	...
	public void testConstructor2() {
		System.out.println("constructor " + "(test probability greater than 1.0)");
		try {
	...
	public void testConstructor3() {
		System.out.println("constructor " + "(test probability between 0.0 and 1.0)");
		try {
	...
	public void testConstructor4() {
		System.out.println("constructor " + "(test probability = 0.0)");
		try {
	...
	public void testConstructor5() {
		System.out.println("constructor " + "(test probability = 1.0)");
		try {
	...
	public void testConstructor6() {
		System.out.println("constructor " + "(test probability = 0.5 and randomGenerator is null)");
		try {
	...
	public void testGetProbability() {
		...
		try {
			final DefaultProbabilisticFunction<Double> function = new DefaultProbabilisticFunction<>(0.5);
