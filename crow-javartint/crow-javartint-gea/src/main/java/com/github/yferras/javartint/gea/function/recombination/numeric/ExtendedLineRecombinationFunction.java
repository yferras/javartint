...
public class ExtendedLineRecombinationFunction<T extends Genome<? extends Chromosome<? extends Gene<Double>>>>
	 ...
	 * @param ranges
	 *            array with the recombination ranges, one per dimension.
	 *            (Typical values from 0.1 to 10E-6)
	 * @param precision
	 *            recombination precisions. (Typical values from 4 to 20)
	 * @throws com.github.yferras.javartint.core.util.ValidationException
	 *             if any.
	 */
	public ExtendedLineRecombinationFunction(double probability, Random random, double[] ranges, double precision) {
	 ...
	 * it uses as random generator an instance of {@link java.util.Random},
	 * <code>probability = 0.75</code>, <code>range = 0.1</code> and
