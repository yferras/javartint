...
public class BinaryMutationFunctionTest {
	...
	public void testEvaluate() throws Exception {
		...
		ByteArrayGene[] genes = new ByteArrayGene[] { new ByteArrayGene(new Byte[] { 0 }),
				new ByteArrayGene(new Byte[] { 1, 1, 0, 1, 0, 0 }), new ByteArrayGene(new Byte[] { 1, 0, 0, 1 }), };
		...
		BinaryMutationFunction<BinaryGenome> function = new BinaryMutationFunction<>();
