...
public class SinglePointRecombinationFunctionTest {
	...
	@Before
	public void setUp() {
		System.out.print(SinglePointRecombinationFunction.class.getName().concat("."));
	}
	...
	public void testEvaluate() throws Exception {
		...
		SinglePointRecombinationFunction<DefaultGenome<DefaultChromosome<DefaultGene<Integer>>>> function = new SinglePointRecombinationFunction<>(
				0.75, GenomeConstants.RANDOM_GENERATOR_1);
