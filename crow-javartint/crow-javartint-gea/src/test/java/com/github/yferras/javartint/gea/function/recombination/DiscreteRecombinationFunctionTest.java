...
public class DiscreteRecombinationFunctionTest {
	...
	@Before
	public void setUp() {
		System.out.print(DiscreteRecombinationFunction.class.getName().concat("."));
	}
	...
	public void testRecombine() throws Exception {
		...
		Gene<Integer>[] genes1 = new DefaultGene[] { new DefaultGene<>(1), new DefaultGene<>(3), new DefaultGene<>(5),
				new DefaultGene<>(7), new DefaultGene<>(9), };

		Gene<Integer>[] genes2 = new DefaultGene[] { new DefaultGene<>(0), new DefaultGene<>(2), new DefaultGene<>(4),
				new DefaultGene<>(6), new DefaultGene<>(8), };
		...
		Gene<Integer>[] expected1 = new DefaultGene[] { new DefaultGene<>(1), new DefaultGene<>(3),
				new DefaultGene<>(4), new DefaultGene<>(6), new DefaultGene<>(9), };

		Gene<Integer>[] expected2 = new DefaultGene[] { new DefaultGene<>(1), new DefaultGene<>(2),
				new DefaultGene<>(4), new DefaultGene<>(7), new DefaultGene<>(9), };
